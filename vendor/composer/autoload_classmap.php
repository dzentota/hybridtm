...
return array(
    ...
    'HybridTM\\Attributes\\AssetId' => $baseDir . '/src/Attributes/AssetId.php',
    'HybridTM\\Attributes\\DataFlow' => $baseDir . '/src/Attributes/DataFlow.php',
    'HybridTM\\Attributes\\Mitigation' => $baseDir . '/src/Attributes/Mitigation.php',
    'HybridTM\\Attributes\\ProcessesData' => $baseDir . '/src/Attributes/ProcessesData.php',
    'HybridTM\\Compiler\\AstResult' => $baseDir . '/src/Compiler/AstResult.php',
    'HybridTM\\Compiler\\AstScanner' => $baseDir . '/src/Compiler/AstScanner.php',
    'HybridTM\\Compiler\\DataFlowVisitor' => $baseDir . '/src/Compiler/DataFlowVisitor.php',
    'HybridTM\\Compiler\\DiscoveredDataFlow' => $baseDir . '/src/Compiler/DiscoveredDataFlow.php',
    'HybridTM\\Compiler\\DiscoveredMitigation' => $baseDir . '/src/Compiler/DiscoveredMitigation.php',
    'HybridTM\\Compiler\\DiscoveredProcessesData' => $baseDir . '/src/Compiler/DiscoveredProcessesData.php',
    'HybridTM\\Compiler\\Linker' => $baseDir . '/src/Compiler/Linker.php',
    'HybridTM\\Console\\CompileCommand' => $baseDir . '/src/Console/CompileCommand.php',
    'HybridTM\\DSL\\CommunicationLink' => $baseDir . '/src/DSL/CommunicationLink.php',
    'HybridTM\\DSL\\DataAsset' => $baseDir . '/src/DSL/DataAsset.php',
    'HybridTM\\DSL\\TechnicalAsset' => $baseDir . '/src/DSL/TechnicalAsset.php',
    'HybridTM\\DSL\\ThreatModel' => $baseDir . '/src/DSL/ThreatModel.php',
    'HybridTM\\DSL\\TrustBoundary' => $baseDir . '/src/DSL/TrustBoundary.php',
    'HybridTM\\Enums\\AssetType' => $baseDir . '/src/Enums/AssetType.php',
    'HybridTM\\Enums\\Authentication' => $baseDir . '/src/Enums/Authentication.php',
    'HybridTM\\Enums\\Authorization' => $baseDir . '/src/Enums/Authorization.php',
    'HybridTM\\Enums\\Availability' => $baseDir . '/src/Enums/Availability.php',
    'HybridTM\\Enums\\BusinessCriticality' => $baseDir . '/src/Enums/BusinessCriticality.php',
    'HybridTM\\Enums\\Confidentiality' => $baseDir . '/src/Enums/Confidentiality.php',
    'HybridTM\\Enums\\DataOrigin' => $baseDir . '/src/Enums/DataOrigin.php',
    'HybridTM\\Enums\\DataUsage' => $baseDir . '/src/Enums/DataUsage.php',
    'HybridTM\\Enums\\Encryption' => $baseDir . '/src/Enums/Encryption.php',
    'HybridTM\\Enums\\Integrity' => $baseDir . '/src/Enums/Integrity.php',
    'HybridTM\\Enums\\Machine' => $baseDir . '/src/Enums/Machine.php',
    'HybridTM\\Enums\\MitigationStatus' => $baseDir . '/src/Enums/MitigationStatus.php',
    'HybridTM\\Enums\\Protocol' => $baseDir . '/src/Enums/Protocol.php',
    'HybridTM\\Enums\\Quantity' => $baseDir . '/src/Enums/Quantity.php',
    'HybridTM\\Enums\\Size' => $baseDir . '/src/Enums/Size.php',
    'HybridTM\\Enums\\Technology' => $baseDir . '/src/Enums/Technology.php',
    'HybridTM\\Enums\\TrustBoundaryType' => $baseDir . '/src/Enums/TrustBoundaryType.php',
    'HybridTM\\Yaml\\ThreagileSerializer' => $baseDir . '/src/Yaml/ThreagileSerializer.php',
